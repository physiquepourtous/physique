...
import { PhysiqueS1Chapters, ChimieS1Chapters, PhysiqueS2Chapters, ChimieS2Chapters, ExamensNationaux } from '@/data/2Bac-SVT-chaptersData';

// Composant pour une carte de chapitre
const ChapterCard = ({ chapter, subject, filiere = "SVT" }) => {
  const resources = [
...
const DevoirSection = ({ semestre, index, filiere = "SVT" }) => {
...
const ExamenCard = ({ year, files, filiere = "SVT" }) => {
  return (
    <div className="chapter-card">
      <h3>{year}</h3>
      <div className="resources">
...
export default function SciencesVieEtTerre() {
  ...
  return (
    <MainLayout title="2ème Bac Sciences de la Vie et de la Terre - Ressources Éducatives">
      <Head>
        <meta name="description" content="Ressources éducatives pour la 2ème Bac Sciences de la Vie et de la Terre en Physique et Chimie. Cours, exercices corrigés, devoirs et conseils." />
        <meta name="keywords" content="2ème bac, svt, sciences de la vie et de la terre, physique, chimie, maroc, lycée, cours, exercices, examens nationaux" />
        <meta property="og:title" content="2ème Bac Sciences de la Vie et de la Terre - Ressources Éducatives" />
        <meta property="og:description" content="Programme complet de Physique et Chimie pour la 2ème Bac Sciences de la Vie et de la Terre avec cours, exercices, conseils, expériences et examens nationaux." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://physiquetous.com/2Bac/SVT" />
        <link rel="canonical" href="https://physiquetous.com/2Bac/SVT" />
      ...
      <main className="container">
        ...
        <section className="intro">
          <h2>Ressources pour la 2ème Bac Sciences de la Vie et de la Terre</h2>
          <p>Vous trouverez ici tous les chapitres du programme officiel de Physique et Chimie pour la 2ème Année Baccalauréat Sciences de la Vie et de la Terre.</p>
        </section>
