...
import { PhysiqueS1Chapters, ChimieS1Chapters, PhysiqueS2Chapters, ChimieS2Chapters, ExamensNationaux } from '@/data/2Bac-SciencesMath-chaptersData';

// Composant pour une carte de chapitre
const ChapterCard = ({ chapter, subject, filiere = "SciencesMath" }) => {
  const resources = [
...
const DevoirSection = ({ semestre, index, filiere = "SciencesMath" }) => {
...
const ExamenCard = ({ year, files, filiere = "SciencesMath" }) => {
  return (
    <div className="chapter-card">
      <h3>{year}</h3>
      <div className="resources">
...
export default function SciencesMathematiques() {
  ...
  return (
    <MainLayout title="2ème Bac Sciences Mathématiques - Ressources Éducatives">
      <Head>
        <meta name="description" content="Ressources éducatives pour la 2ème Bac Sciences Mathématiques en Physique et Chimie. Cours, exercices corrigés, devoirs et conseils." />
        <meta name="keywords" content="2ème bac, sciences mathématiques, physique, chimie, maroc, lycée, cours, exercices, examens nationaux" />
        <meta property="og:title" content="2ème Bac Sciences Mathématiques - Ressources Éducatives" />
        <meta property="og:description" content="Programme complet de Physique et Chimie pour la 2ème Bac Sciences Mathématiques avec cours, exercices, conseils, expériences et examens nationaux." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://physiquetous.com/2Bac/SciencesMath" />
        <link rel="canonical" href="https://physiquetous.com/2Bac/SciencesMath" />
      ...
      <main className="container">
        ...
        <section className="intro">
          <h2>Ressources pour la 2ème Bac Sciences Mathématiques</h2>
          <p>Vous trouverez ici tous les chapitres du programme officiel de Physique et Chimie pour la 2ème Année Baccalauréat Sciences Mathématiques.</p>
        </section>
