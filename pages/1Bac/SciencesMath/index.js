...
import { PhysiqueS1Chapters, ChimieS1Chapters, PhysiqueS2Chapters, ChimieS2Chapters } from '@/data/1Bac-SciencesMath-chaptersData';
...
export default function SciencesMathematiques() {
  ...
  return (
    <MainLayout title="1ère Bac Sciences Mathématiques - Ressources Éducatives">
      <Head>
        <meta name="description" content="Ressources éducatives pour la 1ère Bac Sciences Mathématiques en Physique et Chimie. Cours, exercices corrigés, devoirs et conseils." />
        <meta name="keywords" content="1ère bac, sciences mathématiques, physique, chimie, maroc, lycée, cours, exercices" />
        <meta property="og:title" content="1ère Bac Sciences Mathématiques - Ressources Éducatives" />
        <meta property="og:description" content="Programme complet de Physique et Chimie pour la 1ère Bac Sciences Mathématiques avec cours, exercices, conseils et expériences." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://physiquetous.com/1Bac/SciencesMath" />
        <link rel="canonical" href="https://physiquetous.com/1Bac/SciencesMath" />
      ...
      <main className="container">
        ...
        <section className="intro">
          <h2>Ressources pour la 1ère Bac Sciences Mathématiques</h2>
          <p>Vous trouverez ici tous les chapitres du programme officiel de Physique et Chimie pour la 1ère Année Baccalauréat Sciences Mathématiques.</p>
        </section>
